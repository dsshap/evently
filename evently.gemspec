...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{Event logging apparatus. Storing events as they occur in the database. Helpful for data mining on events occuring in an application. }
  gem.summary       = %q{Event logging and retrieval.}
  gem.homepage      = ""
